        ...
        <>
          <nav className="navbar navbar-expand-lg navbar-light bg-light nav1 shadow-lg rounded m-1 border border-2 border-dark">
            <div className="container-fluid">
                <a onClick={()=>setit(0)} style={{ cursor: 'pointer' }}><img className='image-icon1' src="https://www.georgiascreenprints.com/creartivemind/wp-content/themes/porto/images/logo/logo_ecommerce_black.png" alt="" /></a>
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <a onClick={()=>setit(1)} style={{ cursor: 'pointer' }} className="nav-link fw-bold" aria-current="page">Men</a>
                    </li>
                    <li className="nav-item">
                    <a onClick={()=>setit(2)} style={{ cursor: 'pointer' }} className="nav-link fw-bold" aria-current="page">Women</a>
                    </li>
                    <li className="nav-item">
                    <a onClick={()=>setit(3)} style={{ cursor: 'pointer' }} className="nav-link fw-bold" aria-current="page">Electronics</a>
                    </li>
                    <li className="nav-item">
                    <a onClick={()=>setit(4)} style={{ cursor: 'pointer' }} className="nav-link fw-bold" aria-current="page">Jewelery</a>
                    </li>
                </ul>
                </div>
